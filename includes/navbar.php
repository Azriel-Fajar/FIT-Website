 ...
 * Uses BASE_PATH from config.php for cross-environment compatibility
 * Set $activePage before including ('home', 'about', 'category-data', etc.)
 */
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-fit fixed-top" id="mainNavbar">
    <div class="container">
        <a class="navbar-brand" href="<?php echo route('/'); ?>">
            <img src="<?php echo asset('img/FIT-Logo.png'); ?>" alt="FIT Competition 2026">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarDesktop">
            <ul class="navbar-nav align-items-center gap-1">
                <li class="nav-item">
                    <a class="nav-link <?php echo ($activePage === 'home') ? 'active' : ''; ?>" href="<?php echo route('/'); ?>">Home</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo route('/category-data'); ?>">Data Science</a></li>
                        <li><a class="dropdown-item" href="<?php echo route('/category'); ?>">Web Development</a></li>
                        <li><a class="dropdown-item" href="<?php echo route('/category-mobile'); ?>">Mobile Application</a></li>
                        <li><a class="dropdown-item" href="<?php echo route('/category-cyber'); ?>">Cyber Security</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo ($activePage === 'about') ? 'active' : ''; ?>" href="<?php echo route('/about'); ?>">About Us</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="offcanvas offcanvas-end offcanvas-fit" tabindex="-1" id="offcanvasNav" aria-labelledby="offcanvasNavLabel">
    <div class="offcanvas-header">
        <a href="<?php echo route('/'); ?>">
            <img src="<?php echo asset('img/FIT-Logo.png'); ?>" alt="FIT" style="height: 36px;">
        </a>
