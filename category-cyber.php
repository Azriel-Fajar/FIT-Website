...
<section class="category-hero">
    <div class="container fade-in-up">
        <img src="<?php echo asset('img/cyber/Logo-Page-Cyber.png'); ?>" alt="Cyber Security" class="category-hero-icon">
...
<section class="guidebook-section">
    <div class="container">
        ...
        <div class="guidebook-card glass mx-auto fade-in-up">
            ...
            <a href="<?= asset('guidebooks/GuideBook Finalist Cybersecurity.pdf') ?>" download class="btn-glow">
